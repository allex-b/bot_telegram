...
def get_message(message):
    ...
    if message.text == "/json_data":
        ...
        bot.send_message(
            message.from_user.id,
            "К сожалению моя нейронная сеть еще недостаточно развита, в ближайшее время я пройду курс по машинному обучению и стану полноценным ИИ. А пока используй /start.",
        )
